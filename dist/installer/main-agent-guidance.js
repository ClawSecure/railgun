...
const WORKFLOW_BLOCK_START = "<!-- railgun:workflows -->";
const WORKFLOW_BLOCK_END = "<!-- /railgun:workflows -->";
const CLI = "node ~/.openclaw/workspace/railgun/dist/cli/cli.js";
const TOOLS_BLOCK = `${WORKFLOW_BLOCK_START}
# Railgun Workflows

Railgun CLI (always use full path to avoid PATH issues):
\`${CLI}\`
