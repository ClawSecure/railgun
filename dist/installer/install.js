...
import { installRailgunSkill } from "./skill-install.js";
...
function upsertAgent(list, agent) {
    ...
    // Never overwrite the user's default (main) agent — it was configured outside railgun.
